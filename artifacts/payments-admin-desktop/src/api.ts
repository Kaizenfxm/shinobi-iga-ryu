...
export const adminApi = {
  ...
  createUser: (data: { email: string; displayName: string; password?: string; phone?: string; roles?: string[]; subscriptionLevel?: string; isFighter?: boolean; sedes?: string[] }) =>
    apiFetch<{ user: AdminUser }>("/admin/users", { method: "POST", body: data }),
  updateUser: (id: number, data: { displayName?: string; email?: string; phone?: string; password?: string; isFighter?: boolean; sedes?: string[] }) =>
